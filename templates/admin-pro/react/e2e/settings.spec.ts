// e2e/settings.spec.ts —— 设置中心用例（vanilla 的设置用例分散在 products/profile spec，
// 本模版集中于此文件；断言语义逐条对齐 vanilla-html/e2e/products.spec.ts 设置段
// 与 vanilla-html/e2e/profile.spec.ts 主题色明暗存储用例）
