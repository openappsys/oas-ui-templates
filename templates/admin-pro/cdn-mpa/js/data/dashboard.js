// 仪表盘数据模块：趋势序列 / 订单构成 / 最近订单（自 vanilla src/data/dashboard.ts 去 TS 移植）
...
// 访问趋势：以 TREND 为基波叠加正弦扰动，天数超过序列长度时循环取值
...
// 订单构成：按比例切分总数，末位吸收取整误差保证合计等于 total
