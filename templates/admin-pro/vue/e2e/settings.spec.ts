// e2e/settings.spec.ts —— 设置中心用例（6 例）
// 移植来源：vanilla-html/e2e/products.spec.ts 的 5 例设置中心用例 +
// vanilla-html/e2e/profile.spec.ts 的「主题色按明暗主题独立存储」用例（归并至此，
...
// 归并自 vanilla profile.spec.ts（明暗分键存储语义）
